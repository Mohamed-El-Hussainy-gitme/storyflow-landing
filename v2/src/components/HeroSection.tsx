...
const HeroSection: React.FC<HeroSectionProps> = ({ onEnterFirstWorld }) => {
  ...
  const title = isArabic
    ? "مطوّر واجهات أمامية (Frontend) يبني صفحات هبوط وتجارب React راقية وواضحة"
    : "Frontend Developer building landing pages and refined React UI experiences";
  ...
  const aboutBody1 = isArabic
    ? "أبني صفحات هبوط، لوحات تحكّم، واجهات متاجر، وتجارب ثلاثية الأبعاد باستخدام React وTypeScript وTailwind CSS مع حركة حديثة خفيفة."
    : "I build landing pages, dashboards, e-commerce UI, and 3D web concepts using React, TypeScript, Tailwind CSS, and subtle modern motion.";
